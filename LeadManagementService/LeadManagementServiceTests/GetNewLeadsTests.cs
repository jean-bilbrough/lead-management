...
namespace LeadManagementServiceTests
{
    ...
    {
        [Fact(Skip="local test server not working correclty yet")]
        public async Task Get_NewLeads_Should_Be_Successful()
        {
        ...
        [Fact]
        public async Task Get_NewLeads_Should_Return_New_Leads()
        {
        ...
        [Fact]
        public async Task Get_NewLeads_Should_Not_Return_Accepted_Leads()
        {
            const string expectedJson = 
                "{" + 
                "\"id\":\"newleads\"," +
        ...
        [Fact]
        public async Task Get_NewLeads_Should_Not_Return_Declined_Leads()
        {
            const string expectedJson = 
                "{" + 
                "\"id\":\"newleads\"," +
