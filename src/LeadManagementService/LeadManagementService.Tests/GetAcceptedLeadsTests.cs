...
using LeadManagementService.AcceptedLeads;
...
namespace LeadManagementServiceTests
{
    public class GetAcceptedLeadsTests
    {
        ...
        public async Task Get_Accepted_Leads_Should_Return_Accepted_Leads()
        {
            ...
            var controller = new AcceptedLeadsController(new LeadsRepository(storage));
        ...
        public async Task Get_Accepted_Leads_Should_Display_Accepted_Price()
        {
            ...
            var newLeadsController = new NewLeadsController(new LeadsRepository(storage));
            await newLeadsController.AcceptLead(5588872);
            
            var acceptedLeadsController = new AcceptedLeadsController(new LeadsRepository(storage));
            var result = await acceptedLeadsController.GetAcceptedLeads();
